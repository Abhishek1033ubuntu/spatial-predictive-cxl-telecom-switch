...
plt.plot(t, lambda_t, color='#d62728', linewidth=2.5, label=r'Ingress Traffic Demand $\lambda_i(t)$')
plt.plot(t, cxl_capacity, color='#1f77b4', linewidth=2.0, linestyle='--', label=r'CXL Predictive Envelope (25-min Lead)')
...
plt.fill_between(years, cxl_tco, legacy_tco, color='#20c997', alpha=0.2, label=r'Net Operator Savings ($27.9M Year 5)')
